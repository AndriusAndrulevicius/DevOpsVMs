...
Get-WebFile -sourceUrl "${scriptPath}StartDockerAgent.ps1" -destinationFile $startDockerAgentScript
Get-WebFile -sourceUrl "${scriptPath}SetupDockerAgentStart.ps1" -destinationFile $setupDockerAgentStartScript
Get-WebFile -sourceUrl "${scriptPath}SetupDockerAgentVM.ps1" -destinationFile $setupDockerAgentVMScript
